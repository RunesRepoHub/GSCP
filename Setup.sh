...
GITHUB_REPO_URL="https://github.com/RunesRepoHub/GSCP.git"
...
echo 'alias gscp-menu="bash ~/GSCP/Script/Menu/Main-Menu.sh"' >> ~/.bashrc

sleep 3 

bash ~/GSCP/Script/Menu/Main-Menu.sh
